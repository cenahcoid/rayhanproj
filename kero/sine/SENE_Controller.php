...
abstract class SENE_Controller
{
    ...
    protected function putJsContent(string $u = '', $__forward = array())
    {
        ...
        if (file_exists($v . '.js')) {
            ...
            trigger_error(TEM_ERR . ': unable to load putJsContent for ' . $v . '.js', E_USER_ERROR);
        }
        return $this;
    }
    ...
    */
    ...
    protected function setUpHeader($title = 'page', $descriptions = 'page', $keyword = 'page', $author = 'page'){
        $this->setTitle($title);
